...
def main():
    ...
    show_slice = 1  #ustaw tkanke, dla ktorej wyswietlic przekroje
    ...
    fileName=os.getcwd()+"\\brain-2017-01\\volumes\\imaging\\A1_grayT1-1mm_resample.nrrd" #wrzuc dane do folderu z kodem
    fileNameSeg=os.getcwd()+"\\brain-2017-01\\volumes\\labels\\hncma-atlas.nrrd"
    tissues_names_colors_tsv = pd.read_csv(os.getcwd()+'\\brain-2017-01/labelinfo/hncma-atlas-lut.tsv', sep='\t')
    tissues_names_colors_ctbl=pd.read_table(os.getcwd()+'\\brain-2017-01/colortables/hncma-atlas-lut.ctbl', comment='#', delim_whitespace=True)
